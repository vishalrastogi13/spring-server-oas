...
public interface StoreApi {
    ...
    default ResponseEntity<Void> deleteOrder(
        @Min(1L) @Parameter(name = "orderId", description = "ID of the order that needs to be deleted", required = true) @PathVariable("orderId") Long orderId
    ) {
    ...
    default ResponseEntity<Order> getOrderById(
        @Min(1L) @Max(10L) @Parameter(name = "orderId", description = "ID of pet that needs to be fetched", required = true) @PathVariable("orderId") Long orderId
    ) {
